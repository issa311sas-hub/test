...
本研究の主目的は，\textbf{日本語タスクにおいて確信度プロンプト設計（Verb.1S / Verb.2S / Ling.1S）が
LLM のキャリブレーション性能を改善するか}を実証的に検証することである。

\textbf{メイン RQ}：日本語タスクにおいて，確信度プロンプト設計は
LLM の較正精度（ECE・Brier Score）を有意に改善するか？
