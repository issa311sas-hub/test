...
> **目標**: 精読 8 本（原計画 15 本から縮減）。本リストは初期シード 15 本＋DEL 関連 7 件。
> **精読対象**: B-1, B-3, A-1 を最優先、残り 5 本は `scope-revision-plan.md` 参照
...
### B-6 ⭐重要（2026-05-20 ゼミ発表にて採用）
- **著者**: Zheng, L., Chiang, W.-L., Sheng, Y., et al.
- **年**: 2023
- **タイトル**: Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena
- **掲載**: NeurIPS 2023
- **URL**: https://arxiv.org/abs/2306.05685
- **一言**: GPT-4 等の強力な LLM を審判役として使い、他の LLM の出力を自動評価する手法（LLM-as-a-Judge）を提案・評価。人間の判定との一致率が高いことを示す。
- **本研究との関連**: 翻訳・自然言語生成タスクの正答判定に LLM-as-a-Judge を導入する際の根拠文献。ゼミ発表 [6] として引用。
